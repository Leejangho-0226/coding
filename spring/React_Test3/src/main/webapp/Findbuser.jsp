...
try {
    ...
    String sql = "SELECT jikwonno, jikwonname, jikwonjik, jikwongen, jikwonpay, buser.buserName " +
                 "FROM jikwon " +
    ...
    while (rs.next()) {
        ...
        result += "\"buser\":\"" + rs.getString("buser.buserName") + "\"";
        result += "},";
    }

    if (count > 0) {
        result = result.substring(0, result.length() - 1);  // 마지막 쉼표 제거
    }
