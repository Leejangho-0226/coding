...
// JpaRepository<엔티티명, 엔티티의@ID필드타입>
public interface SangpumRepository extends JpaRepository<SangpumDto, Integer>{
	...
	// 						findBy칼럼명1And칼럼명2, findBy칼럼명1Or칼럼명2,
	//						findBy칼럼명1And칼럼명2GreaterThan값, findBy칼럼명1And칼럼명2GreaterThanEqual값,...
	List<SangpumDto> findBySangContaining(String svalue); 	// 검색어가 포함된 : like '%검색어%'
	// select * from sangdata where sang like '%검색어%'에 의해 검색된 결과가 List 컬렉션에 담겨 반환됨
	...
	*/
	...
	List<SangpumDto> searchMyMethod(@Param("svalue")String svalue); // @Parm 사용
